       ...
       protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            txtBlNome.Text = pokemon.Name;
            txtBlTipo.Text = "Tipo: " + pokemon.Tipo;
            txtBlVida.Text = "Vida: " + pokemon.HP + " HP";
            txtBlAtaque.Text = "Ataque: " + pokemon.Ataque;
            txtBlDefesa.Text = "Defesa: " + pokemon.Defesa;
